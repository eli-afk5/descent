...
ADescentPlayerController::ADescentPlayerController()
{
	...
	PlayerCameraManagerClass = ADescentCameraManager::StaticClass();
}
...
void ADescentPlayerController::BeginPlay()
{
	...
	if (ShouldUseTouchControls() && IsLocalPlayerController())
	{
		...
		if (MobileControlsWidget)
		{
			...
			UE_LOG(LogDescent, Error, TEXT("Could not spawn mobile controls widget."));
...
bool ADescentPlayerController::ShouldUseTouchControls() const
{
