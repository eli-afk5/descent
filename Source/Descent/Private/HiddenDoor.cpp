...
AHiddenDoor::AHiddenDoor()
{
	...
	CollisionBox->OnComponentBeginOverlap.AddDynamic(this, &AHiddenDoor::OnBeginOverlap);
	CollisionBox->OnComponentEndOverlap.AddDynamic(this, &AHiddenDoor::OnEndOverlap);
}
